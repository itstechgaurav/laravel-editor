...
var JSONDocumentSymbols = /** @class */ (function () {
                        ...
                        for (var _i = 0, _a = item.properties; _i < _a.length; _i++) {
                            ...
                            if (property.keyNode.value === 'key') {
                                if (property.valueNode) {
                                    if (property.valueNode) {
                                        var location = _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["Location"].create(document.uri, getRange(document, item));
                                        result_1.push({ name: _parser_jsonParser_js__WEBPACK_IMPORTED_MODULE_0__["getNodeValue"](property.valueNode), kind: _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["SymbolKind"].Function, location: location });
                                    }
                                    return;
                                }
                            }
        ...
        var collectOutlineEntries = function (result, node, containerName) {
            if (node.type === 'array') {
                ...
                node.properties.forEach(function (property) {
                    var location = _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["Location"].create(document.uri, getRange(document, property));
                        ...
                        for (var _i = 0, _a = item.properties; _i < _a.length; _i++) {
                            ...
                            if (property.keyNode.value === 'key') {
                                if (property.valueNode) {
                                    ...
                                    result_2.push({ name: _parser_jsonParser_js__WEBPACK_IMPORTED_MODULE_0__["getNodeValue"](property.valueNode), kind: _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["SymbolKind"].Function, range: range, selectionRange: selectionRange });
                                }
                                return;
                            }
                        }
    ...
    JSONDocumentSymbols.prototype.getSymbolKind = function (nodeType) {
        switch (nodeType) {
            case 'object':
                return _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["SymbolKind"].Module;
            case 'string':
                return _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["SymbolKind"].String;
            case 'number':
                return _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["SymbolKind"].Number;
            case 'array':
                return _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["SymbolKind"].Array;
            case 'boolean':
                return _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["SymbolKind"].Boolean;
            default: // 'null'
                return _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["SymbolKind"].Variable;
        }
    };
    ...
    JSONDocumentSymbols.prototype.getColorPresentations = function (document, doc, color, range) {
        ...
        result.push({ label: label, textEdit: _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["TextEdit"].replace(range, JSON.stringify(label)) });
        return result;
    };
...
function getRange(document, node) {
    return _vscode_languageserver_types_main_js__WEBPACK_IMPORTED_MODULE_4__["Range"].create(document.positionAt(node.offset), document.positionAt(node.offset + node.length));
}
