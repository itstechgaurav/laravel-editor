    ...
    <div class="w-10 main-editor-page" v-if="config.isReady">
        <div id="main-nav" class="nav nav-dark nav-corner">
            ...
            <div class="nav-body ml-3">
                <div class="nav-item ml-2" v-if="loged">
                    <div
                        class="badge badge-prime badge-s ripple"
                        @click="like()"
                    >
                        <i
                            :class="[
                                'ion ion-heart pointer',
                                liked ? 'text-sec' : '',
                            ]"
                ...
                <div class="nav-item v-center">
                    ...
                    <label
                        class="button-toggle bg-white title-tip title-tip-bottom title-tip-light"
                        data-title="Run Code Live"
                    >
                ...
                <div class="nav-item ml-1" v-if="loged">
                    <div
                        class="dropdown dropdown-dark dropdown-icon-hide p-0 m-0"
                    >
                        <div
                            class="dropdown-head p-0"
                            style="padding: 0 !important"
                        >
                            <img
                                :src="`/uploads/${data.cUser.image}`"
                                width="30"
                                height="30"
                                class="rad-c"
                                alt=""
                        ...
                        <div class="dropdown-body hide-scroll" style="right: 0">
                            ...
                            <div class="dropdown-item">
                                <a href="/main/proj" class="link link-white"
                                    >Projects</a
                                >
                            </div>
                        </div>
        ...
        <div class="mainPanel">
                ...
                <div class="left-window">
                    <div class="left-window-left">
                        <div
                            data-title="Files"
                            :class="[
                                'left-window-item title-tip title-tip-right title-tip-light',
                                {
                                    'left-window-item-active':
                                        config.window === 'window-fs',
                                },
                            ]"
                            @click="chnageWindow('window-fs')"
                        >
                        ...
                        <div
                            ...
                            @click="chnageWindow('window-settings')"
                        >
                        ...
                        <div
                            ...
                            :class="[
                                ...
                                {
                                    'left-window-item-active':
                                        config.window === 'window-libs',
                                },
                            ]"
                            @click="chnageWindow('window-libs')"
                        >
                            <i class="ion ion-plus-round"></i>
                        </div>
                        <div
                            data-title="Run Code"
                            class="left-window-item title-tip title-tip-right title-tip-light"
                            @click="runCode()"
                        >
                            <i class="ion ion-play"></i>
                        </div>
                        <div
                            data-title="Save Code"
                            class="left-window-item title-tip title-tip-right title-tip-light"
                            @click="upload()"
                            v-if="data.own"
                        >
                        ...
                        <div
                            ...
                            :class="[
                                ...
                                {
                                    'left-window-item-active':
                                        config.window === 'window-user',
                                },
                            ]"
                            @click="chnageWindow('window-user')"
                        >
            ...
            <div class="mainPanel-right">
                <div
                    :class="['panel', { 'panel-open': config.codePanelOpen }]"
                    data-usePanel="left"
                    id="codePanel"
                >
                    <div class="panel-left panel-left-fs d-f space-b dir-col">
                        <div
                            class="fs-nav"
                            v-show="config.window === 'window-fs'"
                        >
                            <div
                                class="fs-file"
                                v-for="file in fs"
                    ...
                    <libs-tab
                        v-show="config.window === 'window-libs'"
                    ></libs-tab>
                    <assets-tab
                        :assets="data.assets"
                        v-show="config.window === 'window-assets'"
                    ></assets-tab>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        fork() {
            let url = this.demo
                ? "/editor/demo-project/fork"
                : window.location.pathname + "/fork";
            axios
                .post(url)
                .then((res) => {
