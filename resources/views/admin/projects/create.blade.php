        ...
        <div class="row space-a">
            <div class="card col-6 col-8-md col-10-sm col-12-xs">
                <div class="card-head text-center">
                    <div class="heading-ter">Create New Project</div>
                </div>
                <div class="card-body w-9 mx-a">
                    <form action="" method="POST">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <input spellcheck="false" name="name" type="text" class="input-input" placeholder="Project Name">
                            <div class="input-a-anm input-a-anm-center"></div>
                        </div>
                        <div class="form-group">
                            <textarea name="meta" class="textarea" placeholder="Brief Discription About This Project"></textarea>
                        </div>
                        ...
                        <div class="form-group text-center">
                            <button class="btn btn-ter ripple">Create Project</button>
                        </div>
                    </form>
                </div>
            </div>
