        ...
        <div class="row space-a">
            <div class="card col-6">
                <div class="card-head text-center">
                    <div class="heading-ter">Create Tag</div>
                </div>
                <div class="card-body w-9 mx-a">
                    <form action="" method="POST">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <input name="name" spellcheck="false" type="text" class="input-input" placeholder="Tag Name">
                            <div class="input-a-anm input-a-anm-center"></div>
                        </div>
                        <div class="form-group text-center">
                            <button class="btn btn-ter ripple">Add Tag</button>
                        </div>
                    </form>
                </div>
            </div>
